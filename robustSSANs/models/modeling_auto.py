...
# from robustSSANs.models.modeling_bert import (
#     BertForMaskedLM,
...
from robustSSANs.models.modeling_roberta import (
    RobertaForCausalLM,
    RobertaForMaskedLM,
...
from transformers.models.wav2vec2.modeling_wav2vec2 import Wav2Vec2ForMaskedLM, Wav2Vec2Model
...
from robustSSANs.models.configuration_bert import BertConfig
...
AUTO_MODEL_PRETRAINED_DOCSTRING = r"""
        ...
        The model is set in evaluation mode by default using ``model.eval()`` (so for instance, dropout robustSSANs are
            ...
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A string, the `model id` of a pretrained model hosted inside a model repo on huggingface.co.
                      Valid model ids can be located at the root-level, like ``bert-base-uncased-base-uncased``, or namespaced under
                      a user or organization name, like ``dbmdz/bert-base-uncased-base-german-cased``.
...
class AutoModel:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> config = AutoConfig.from_pretrained('bert-base-uncased-base-uncased')
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> model = AutoModel.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModel.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
...
class AutoModelForPreTraining:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForPreTraining.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForPreTraining.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelWithLMHead:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelWithLMHead.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelWithLMHead.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForMaskedLM:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForMaskedLM.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForMaskedLM.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForSequenceClassification:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForSequenceClassification.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForSequenceClassification.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForQuestionAnswering:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForQuestionAnswering.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForQuestionAnswering.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForTokenClassification:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForTokenClassification.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForTokenClassification.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForMultipleChoice:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForMultipleChoice.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForMultipleChoice.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
...
class AutoModelForNextSentencePrediction:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> # Download model and configuration from huggingface.co and cache.
            >>> model = AutoModelForNextSentencePrediction.from_pretrained('bert-base-uncased-base-uncased')

            >>> # Update configuration during loading
            >>> model = AutoModelForNextSentencePrediction.from_pretrained('bert-base-uncased-base-uncased', output_attentions=True)
            >>> model.config.output_attentions
            True
